...
function App() {
  ...
  useEffect(() => {
    ...
    ScrollTrigger.matchMedia({
      // desktop
      "(min-width: 268px) and (max-width: 1200px) and (orientation: portrait) and (min-height: 612px)":
        function () {
          // first section
          ...
          t3.to(
            "#circle1,#circle2,#circle3,#circle6,#circle5,#circle7",
            {
              top: "214%",
              left: "6%",
              rotate: "180deg",
      ...
      "(min-width: 1024px) and (max-width: 1439px) and (min-height: 768px)":
        function () {
          // first section
          var tl = gsap.timeline({
            scrollTrigger: {
      ...
      "(min-width: 1600px) and (max-width: 2559px) and (min-height: 900px) and (max-height: 1440px)":
        function () {
          // first section
          var tl = gsap.timeline({
            scrollTrigger: {
    ...
    gsap.to("#box1", {
      ...
      scrollTrigger: {
        ...
        start: "10% 80%",
        onEnter: () =>
          gsap.to("#box1", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
        onLeaveBack: () =>
          gsap.to("#box1", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onLeave: () =>
          gsap.to("#box1", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onEnterBack: () =>
          gsap.to("#box1", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
    ...
    gsap.to("#box2", {
      ...
      scrollTrigger: {
        ...
        start: "10% 80%",
        onEnter: () =>
          gsap.to("#box2", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
        onLeaveBack: () =>
          gsap.to("#box2", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onLeave: () =>
          gsap.to("#box2", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onEnterBack: () =>
          gsap.to("#box2", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
    ...
    gsap.to("#box3", {
      ...
      scrollTrigger: {
        ...
        start: "10% 80%",
        onEnter: () =>
          gsap.to("#box3", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
        onLeaveBack: () =>
          gsap.to("#box3", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onLeave: () =>
          gsap.to("#box3", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onEnterBack: () =>
          gsap.to("#box3", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
    ...
    gsap.to("#box4", {
      ...
      scrollTrigger: {
        ...
        start: "10% 80%",
        onEnter: () =>
          gsap.to("#box4", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
        onLeaveBack: () =>
          gsap.to("#box4", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onLeave: () =>
          gsap.to("#box4", { scale: 1, duration: 1.3, ease: "expo.inOut" }),
        onEnterBack: () =>
          gsap.to("#box4", { scale: 20, duration: 1.3, ease: "expo.inOut" }),
  ...
  return (
    <div
      ref={containerRef}
      className={`smooth-scroll ${screen.width < 768 ? "overflow-hidden" : ""}`}
    >
      <div className="app-max-container">
          ...
          <div className="container">
            <div className="hero-content">
              ...
              <div className="main-container max-h-[80%] flex flex-col md:flex-row w-full gap-4">
                ...
                >
                  <h1 className="font-extrabold text-6xl  md:text-6xl lg:text-7xl">
                    Content
                  </h1>
                  <h1 className="font-extrabold text-6xl md:text-6xl lg:text-7xl">
                    Marketing
                ...
                <div className="h-full w-full flex items-center justify-center">
                  <div className="marquee h-full w-full rounded-4xl">
                    <div className="marquee-content h-full w-full gap-6 md:gap-12 flex items-center">
                      <img
                        src={axisbank}
                        className="h-[10%] md:h-full w-[50%] md:w-auto"
                        alt="Client Logo 1"
                      />
                      <img
                        src={ovenry}
                  ...
                  <div className="hidden md:visible absolute top-0 left-0 h-full w-[40%] from-white to-transparent bg-gradient-to-r"></div>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <div
          className="second-section slide slide2 flex items-center justify-center"
          id="slide2"
        >
          <div
            style={{
              backgroundImage: `url(${isDarkMode ? Black_image : White_image})`,
            }}
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              className={`block w-full font-extrabold text-4xl md:text-5xl lg:text-6xl text-center leading-tight ${
        ...
        <div
          className={`sticky-sections slide flex flex-col ${
        ...
        >
          {/* <div className='container'> */}
          <div
            className={`sticky-section1 ${
              isDarkMode ? "bg-black" : "bg-white"
            } h-screen w-full sticky-1 flex`}
          >
            <div
              className={`left ${
                isDarkMode ? "bg-black" : "bg-white"
            ...
            >
              <div
                className={`h-20 w-72 md:w-128 flex items-center mt-20 ${
                  isDarkMode ? "bg-black" : "bg-white"
                }`}
              >
                <div
                  className={`h-[60px] w-[60px] md:h-full md:w-20 rounded-full  border-3 border-dotted border-${
                    isDarkMode ? "white" : "black"
                  } myCustomSpin flex items-center justify-center`}
                >
                  <div className="h-[80%] w-[80%] bg-[#BBDEFB] rounded-full"></div>
                </div>
                <span className="md:text-3xl text-2xl lg:text-4xl font-bold ml-4">
                  Content marketing
                </span>
              </div>
            ...
            <div
              className={` h-[60%] absolute top-1/6 left-1/2 hidden md:block`}
            >
              {isDarkMode ? (
                <DotLottieReact
        ...
        <div
          className={`fourth-section mx-1 slide slide4 flex items-center justify-center gap-2 ${
            isDarkMode ? "bg-black" : "bg-white"
          }`}
          id="slide4"
        >
              ...
              <ul className="pl-10 pr-10 pt-2 pb-2 text-base md:text-base list-disc list-inside space-y-3">
                <li className="flex items-center gap-2">
                  ...
                  <span className=" text-gray-800">
                    Designing the Web, Defining Success
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-black font-semibold">•</span>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="absolute -top-8 md:-top-14 left-4 md:left-8 z-20">
                  <span className="text-[100px] md:text-[150px] leading-none text-[#ff4d6d]">
                    "
                  </span>
                </div>
                  ...
                  <div className="md:mt-10 max-w-3xl mx-auto px-2 md:px-4 text-center md:text-left">
                    <div className="space-y-3 md:space-y-6">
                      ...
                      <div className="text-center md:text-left">
                        <p
                          className={`text-base md:text-2xl font-semibold md:font-medium ${
                            isDarkMode ? "text-gray-300" : "text-gray-800"
                          }`}
                        >
                          Founder, Managing Director & Creative Lead at Fusion
                          Media
                        </p>
                      </div>
                      <p
                        className={`mt-2 md:mt-6 text-sm md:text-xl leading-relaxed md:px-0 px-1 ${
                          isDarkMode ? "text-gray-400" : "text-gray-600"
                        }`}
                      >
                        Passionate about blending creativity with strategy, the
                        vision behind Fusion Media is rooted in delivering
                        powerful brand stories and engaging digital experiences.
                        With a strong belief in the impact of design,
                        storytelling, and innovation, the focus has always been
                        on helping brands grow through bold ideas and modern
                      ...
                      <div className="mt-3 md:mt-6">
                        <a
                          ...
                          className={`inline-flex items-center justify-center px-3 md:px-6 py-2 md:py-3 rounded-lg text-sm md:text-lg ${
                            isDarkMode
            ...
            <div className="max-w-3xl mx-auto text-left py-8 px-8 md:px-16">
              <div className="space-y-2">
                ...
                >
                  ...
                  initiatives. His expertise in market analysis and business
                  development has been instrumental in establishing Fusion Media
                  as a leading creative agency.
                </p>
                <div className="pt-2">
                  <a
        ...
        >
          ...
          <div className="max-w-[1000px] mx-auto flex flex-col items-center relative bg-gray-400/10 rounded-lg p-2">
            {/* Quote Mark */}
            <span className="absolute -left-20 top-0 text-[#FF3366] text-[180px] md:text-[180px] font-serif leading-none hidden md:block">
              "
            </span>
        ...
        <div
          className="last-section bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20 md:rounded-lg mt-22 h-[280px] flex items-center justify-center"
          style={{ zIndex: 2147483, position: "relative" }}
        >
          <h2
            className="text-5xl md:text-6xl font-bold text-center max-w-4xl mx-auto leading-tight"
