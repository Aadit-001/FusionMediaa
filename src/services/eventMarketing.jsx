      ...
      <div className="flex flex-col justify-center items-center md:min-h-screen md:mt-2">
        <div className="container">
          <div className="relative mt-30 md:mt-0 px-0 lg:px-[10%] ">
            <div className="">
              <h1 className="text-[#FF4D6D] text-2xl font-bold lg:font-semibold">EVENT MARKETING</h1>
            </div>
            <nav className="flex items-center gap-2 text-lg">
              ...
              <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>•</span>
              <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>Event Marketing</span>
            </nav>
          </div>
          <div className='h-full w-full md:flex md:flex-row md:justify-between md:items-center'>
            ...
            <div className="w-full md:w-1/2 flex items-center lg:justify-start justify-center  md:right-1 md:top-1/3 lg:pl-20">
              ...
              >
                WE CREATE
                <span className="text-[#FF4D6D]"> MEMORABLE </span>
                EVENTS THAT CONNECT.
              </motion.h1>
            </div>
          </div>
          ...
          <div className="space-y-10">
            <div className="flex flex-col space-y-8">
              ...
              <motion.div
                ...
                className="space-y-8"
              >
                <h3 className={`text-4xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Strategic Event Management</h3>
