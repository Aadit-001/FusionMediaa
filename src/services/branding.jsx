    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-black' : 'bg-white'} smooth-scroll`} ref={containerRef}>
      ...
      <div className="absolute top-20 right-[30%] mt-14">
        ...
        <nav className="flex items-center gap-2 text-lg justify-end">
          ...
          <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>•</span>
          <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>Branding</span>
        </nav>
      </div>
      ...
      <div className={`px-8 py-16 services1-section ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="mb-16"
          >
            <h1 className={`text-[#FF4D6D] text-2xl font-bold mb-6 tracking-wide text-left ml-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>What Do We Serve ?</h1>
