...
const Branding = () => {
  ...
  const services = [
    ...
    { title: "Stories & Reels Creation" },
    { title: "Strategy" },
    { title: "Influencer Discovery" },
    { title: "Partnership" },
    { title: "Sponsered Post" },
    { title: "Influencer Events" },
    { title: "Engagement Posting Campaign" }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "Creating tailored social media strategies aligned with your brand voice and goals"
    },
    {
      icon: (
        <motion.svg 
      ...
      description: "Developing engaging content that resonates with your target audience across platforms"
    },
    {
      icon: (
        <motion.svg 
      ...
      description: "Building and nurturing active communities through meaningful interactions"
    },
    {
      icon: (
        <motion.svg 
      ...
      description: "Analyzing metrics and optimizing campaigns for maximum engagement and ROI"
    }
  ];
    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-black' : 'bg-white'} smooth-scroll`} ref={containerRef}>
      ...
      <div className="flex flex-col justify-center items-center md:min-h-screen md:mt-2">
        <div className="container">
          <div className="relative mt-30 md:mt-0 px-0 lg:px-[10%] ">
            <div className="">
              <h1 className="text-[#E1BEE7] text-2xl font-bold lg:font-semibold">SOCIAL MEDIA MARKETING</h1>
            </div>
          ...
          <div className='h-full w-full md:flex md:flex-row md:justify-between md:items-center'>
            ...
            <div className={`relative circless border-4 ${isDarkMode ? 'border-white' : 'border-slate-900'} mt-10 ml-[16%] md:ml-[0%]`} id="circle11">
              <DotLottieReact
                ...
                autoplay
              />
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-8 md:w-12 -ml-16 md:-ml-24 md:h-12 bg-[#E1BEE7] rounded-full"></div>
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-8 h-8 md:w-12 ml-16 md:ml-24 md:h-12 bg-[#E1BEE7] rounded-full" ></div>
            </div>
            <div className="absolute w-12 h-12 bg-[#E1BEE7] rounded-full" id="circle13"></div>
            ...
            <div className="w-full md:w-1/2 flex items-center lg:justify-start justify-center  md:right-1 md:top-1/3 lg:pl-20">
              ...
              >
                WE CREATE
                <span className="text-[#E1BEE7]"> ENGAGING </span>
      ...
      <div className="ser-section px-8 py-16  ">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="mb-16"
          >
            <h1 className="text-[#E1BEE7] text-2xl font-bold mb-6 tracking-wide text-left">What Do We Serve ?</h1>
            <h3 className={`text-4xl font-bold max-w-3xl leading-tight text-left ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            We help you build a strong social media presence that drives engagement and growth.
            </h3>
          </motion.div>
      ...
      <div className={` px-8 py-24 ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className={`text-[#E1BEE7] text-2xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>HOW WE DO IT ?</h2>
            ...
            {processSteps.map((step, index) => (
              ...
              >
                ...
                {index < processSteps.length - 1 && (
                  ...
                  >
                    <motion.div
                      className="absolute right-0 -top-1 w-2 h-2 bg-[#E1BEE7] rounded-full"
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
      ...
      <div className={`px-8 py-20 ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
        <div className="max-w-6xl mx-auto">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-[#E1BEE7] text-4xl font-medium mb-12 text-left"
          >
          ...
          <div className="space-y-10">
            <div className="flex flex-col space-y-8">
              ...
              >
                <img
                  src="https://www.601media.com/wp-content/uploads/2023/05/fi_socialmedia-001.jpg"
              ...
              <motion.div
                ...
                className="space-y-8"
              >
                <h3 className={`text-4xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Strategic Social Media Management</h3>
                <p className={`text-xl leading-relaxed max-w-3xl ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                Creating engaging social media content and managing your online presence to build brand awareness and drive meaningful engagement.
                </p>
      ...
      <div className={`px-8 py-24 ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
        <div className="max-w-6xl mx-auto">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-[#E1BEE7] text-4xl font-medium mb-16 text-left"
          >
