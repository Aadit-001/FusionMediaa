...
const Branding = () => {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-black' : 'bg-white'} smooth-scroll`} ref={containerRef}>
      {/* Top Navigation */}
      <div className="absolute top-20 right-[22%] mt-14">
        <div className="mb-4 -ml-[5px]">
          <h1 className="text-[#FF4D6D] text-2xl font-semibold">Social Media Marketing</h1>
        </div>
        <nav className="flex items-center gap-2 text-lg justify-end">
          ...
          <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>•</span>
          <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>Social Media Marketing</span>
        </nav>
      </div>
                    ...
                    <div className="w-1/2 flex items-center absolute right-1 top-1/3 ml-48 pl-20">
                      <div className="max-w-xl">
                        <div className="mb-4">
                          ...
                          >
                            We drive<br />
                            <span className="text-[#FF4D6D]">engaging</span><br />
                            social<br />
                            conversations.
                          </motion.h1>
                        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h3 className={`text-4xl font-bold max-w-3xl leading-tight text-left ml-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              We create and manage compelling social media presence that engages your audience and drives meaningful conversations across platforms.
            </h3>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            <div className="flex flex-col space-y-8">
              ...
              >
                <img
                  src="https://s39940.pcdn.co/wp-content/uploads/2023/02/iStock-1400358779.jpg"
              ...
              >
                <h3 className={`text-4xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Strategic Social Media Marketing</h3>
                <p className={`text-xl leading-relaxed max-w-3xl ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                  We help brands thrive in the social media landscape through strategic content, community management, and data-driven campaigns that deliver measurable results and foster authentic connections.
                </p>
                <div className={`flex items-center gap-x-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  <span className="font-medium">Platform Strategy</span>
