    ...
    <div className="min-h-screen bg-white smooth-scroll" ref={containerRef}>
      ...
      <div className="absolute top-20 right-[32%] mt-14">
        ...
        <nav className="flex items-center gap-2 text-lg justify-end">
          ...
          <span className="text-gray-400">•</span>
          <span className="text-gray-400">OOH</span>
        </nav>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            <div className="flex flex-col space-y-8">
              ...
              >
                <img
                  src="https://swotandpestleanalysis.com/wp-content/uploads/2022/09/What-is-OOH-advertising.jpg"
              ...
              >
                <h3 className="text-4xl font-bold">Outdoor Advertising Excellence</h3>
